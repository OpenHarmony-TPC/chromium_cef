...
//
// $hash=264110687f50cf8d451265b7c74c1be904d6c43d$
//
...
int CEF_CALLBACK cookie_manager_visit_url_cookies(
    ...
    int includeHttpOnly, struct _cef_cookie_visitor_t *visitor, int is_sync,
    int is_from_ndk) {
  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING
...
int CEF_CALLBACK cookie_manager_set_cookie(
    ...
    struct _cef_set_cookie_callback_t *callback, int is_sync,
    const cef_string_t *str_cookie, int includeHttpOnly) {
  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING
