...
#ifndef CEF_LIBCEF_BROWSER_ALLOY_CHROME_OFF_THE_RECORD_PROFILE_ALLOY_H_
#define CEF_LIBCEF_BROWSER_ALLOY_CHROME_OFF_THE_RECORD_PROFILE_ALLOY_H_
...
class ChromeOffTheRecordProfileAlloy : public Profile {
 public:
  ChromeOffTheRecordProfileAlloy(Profile* original_profile);

  ChromeOffTheRecordProfileAlloy(const ChromeOffTheRecordProfileAlloy&) = delete;
  ChromeOffTheRecordProfileAlloy& operator=(const ChromeOffTheRecordProfileAlloy&) = delete;

  ~ChromeOffTheRecordProfileAlloy() override;
