...
struct libcef_pointers {
  ...
  decltype(&cef_apply_http_dns) cef_apply_http_dns;
  decltype(&cef_set_download_handler) cef_set_download_handler;
  decltype(&cef_resume_download) cef_resume_download;
