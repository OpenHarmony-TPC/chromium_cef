...
//
// $hash=a328b2b0d6399cd93fab0320cde59d75d2da1aad$
//
...
int CEF_CALLBACK browser_host_discard_web(struct _cef_browser_host_t* self) {
  shutdown_checker::AssertNotShutdown();
  ...
  // Execute
  bool _retval = CefBrowserHostCppToC::Get(self)->DiscardWeb();

  // Return type: bool
  return _retval;
}

int CEF_CALLBACK browser_host_reload_web(struct _cef_browser_host_t* self) {
  shutdown_checker::AssertNotShutdown();
  ...
  // Execute
  bool _retval = CefBrowserHostCppToC::Get(self)->ReloadWeb();
...
CefBrowserHostCppToC::CefBrowserHostCppToC() {
  ...
  GetStruct()->discard_web = browser_host_discard_web;
  GetStruct()->reload_web = browser_host_reload_web;
}
