...
#ifndef CEF_LIBCEF_BROWSER_NET_OHOS_APPLINK_THROTTLE_H_
#define CEF_LIBCEF_BROWSER_NET_OHOS_APPLINK_THROTTLE_H_
#pragma once
...
class OhosAppLinkThrottle : public blink::URLLoaderThrottle {
 public:
  explicit OhosAppLinkThrottle(int frame_tree_node_id);
  OhosAppLinkThrottle(int frame_tree_node_id, bool is_client_redirect);
...
#endif  // CEF_LIBCEF_BROWSER_NET_OHOS_APPLINK_THROTTLE_H_