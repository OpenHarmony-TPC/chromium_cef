...
//
// $hash=369096406b6da01e3ffd51f4c00ef5366267ad2c$
//
...
void CEF_CALLBACK browser_host_send_key_event(
    struct _cef_browser_host_t *self, const struct _cef_key_event_t *event) {
  shutdown_checker::AssertNotShutdown();
...
void CEF_CALLBACK browser_host_store_web_archive(
    ...
    int auto_name, struct _cef_store_web_archive_result_callback_t *callback) {
  shutdown_checker::AssertNotShutdown();
...
void CEF_CALLBACK browser_host_execute_java_script(
    ...
    struct _cef_java_script_result_callback_t *callback, int extention) {
  shutdown_checker::AssertNotShutdown();
...
int CEF_CALLBACK browser_host_finish_discard(struct _cef_browser_host_t *self) {
  shutdown_checker::AssertNotShutdown();
  ...
  // Execute
  bool _retval = CefBrowserHostCppToC::Get(self)->FinishDiscard();

  // Return type: bool
  return _retval;
}

int CEF_CALLBACK browser_host_finish_reload(struct _cef_browser_host_t *self) {
  shutdown_checker::AssertNotShutdown();
  ...
  // Execute
  bool _retval = CefBrowserHostCppToC::Get(self)->FinishReload();
...
CefBrowserHostCppToC::CefBrowserHostCppToC() {
  ...
  GetStruct()->finish_discard = browser_host_finish_discard;
  GetStruct()->finish_reload = browser_host_finish_reload;
}
