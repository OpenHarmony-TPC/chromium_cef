...
class CefContextMenuHandlerExt : virtual public CefContextMenuHandler {
 ...
 public:
  ...
  /// OnGetAllImage
  ///
  virtual void OnGetAllImage(int32_t taskid, uint8_t* data, int buffer_size) {}

  ///
  /// OnGetImageByXPath
  ///
  virtual void OnGetImageByXPath(int32_t taskid, CefRefPtr<CefImage> image, int32_t image_id) {}

  ///
  /// GetImageIdByTaskId
  ///
  virtual int32_t GetImageId(int32_t taskid) {}
