...
void OhosPrintManager::DidDispatchPrintEvent(bool isBefore) {
  ...
  main_task_runner->PostTask(
      FROM_HERE,
      base::BindOnce(&OhosPrintManager::DidDispatchPrintEventImpl,
                     base::Unretained(this), weak_ptr_web_contents_, isBefore));
}

void OhosPrintManager::DidDispatchPrintEventImpl(
