...
class CefLargestContentfulPaintDetailsImpl: public CefLargestContentfulPaintDetails {
 public:
  explicit CefLargestContentfulPaintDetailsImpl(int64_t navigationStartTime,
  ...
  CefLargestContentfulPaintDetailsImpl(const CefLargestContentfulPaintDetailsImpl&) = delete;
  CefLargestContentfulPaintDetailsImpl& operator=(const CefLargestContentfulPaintDetailsImpl&)
      = delete;
