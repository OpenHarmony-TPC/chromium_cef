 ...
 */
#ifndef CEF_LIBCEF_BROWSER_NET_SERVICE_INCOGNITO_COOKIE_MANAGER_OHOS_IMPL_H_
#define CEF_LIBCEF_BROWSER_NET_SERVICE_INCOGNITO_COOKIE_MANAGER_OHOS_IMPL_H_
...
// thread.
class CefIncognitoCookieManagerImpl : public CefCookieManager {
 public:
  static CefRefPtr<CefIncognitoCookieManagerImpl> GetInstance();

  CefIncognitoCookieManagerImpl(const CefIncognitoCookieManagerImpl&) = delete;
  CefIncognitoCookieManagerImpl& operator=(const CefIncognitoCookieManagerImpl&) = delete;
  ...
  bool VisitUrlCookies(const CefString& url,
                       ...
                       bool is_sync,
                       bool is_from_ndk = false) override;
 ...
 private:
  ...
  IMPLEMENT_REFCOUNTING(CefIncognitoCookieManagerImpl);
};

#endif // CEF_LIBCEF_BROWSER_NET_SERVICE_INCOGNITO_COOKIE_MANAGER_OHOS_IMPL_H_
