...
void IconHelper::DownloadFavicon(const blink::mojom::FaviconURLPtr& candidate, int request_id, const CefRefPtr<CefBrowser>& browser) {
  if (!web_contents_) {
...
void IconHelper::DownloadFaviconHandler(
  ...
  OnReceivedIcon(pixels, pixel_width, pixel_height, color_type, alpha_type, browser);
