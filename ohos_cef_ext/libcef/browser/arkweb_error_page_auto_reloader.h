...
class ErrorPageAutoReloader
    : public content::WebContentsObserver,
      public content::WebContentsUserData<ErrorPageAutoReloader>,
      public network::NetworkConnectionTracker::NetworkConnectionObserver {
 public:
  ErrorPageAutoReloader(const ErrorPageAutoReloader&) = delete;
  ErrorPageAutoReloader& operator=(const ErrorPageAutoReloader&) = delete;
  ~ErrorPageAutoReloader() override;

  // Maybe installs a throttle for the given navigation, lazily initializing the
  // appropriate WebContents' ErrorPageAutoReloader instance if necessary. For
 ...
 private:
  friend class content::WebContentsUserData<ErrorPageAutoReloader>;

  explicit ErrorPageAutoReloader(content::WebContents* web_contents);
  ...
  base::WeakPtrFactory<ErrorPageAutoReloader> weak_ptr_factory_{this};
