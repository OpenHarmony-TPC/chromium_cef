...
#ifndef CEF_LIBCEF_BROWSER_EXTENSIONS_API_SCRIPTING_SCRIPTING_API_H_
#define CEF_LIBCEF_BROWSER_EXTENSIONS_API_SCRIPTING_SCRIPTING_API_H_
...
#endif  // CEF_LIBCEF_BROWSER_EXTENSIONS_API_SCRIPTING_SCRIPTING_API_H_
