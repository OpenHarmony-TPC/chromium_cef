...
[master](https://gitcode.com/openharmony-tpc/chromium_cef/tree/pc_chromium_138)
...
1. 从代码仓克隆chromium-cef仓库。
   ...
   $ git clone -b pc_chromium_138 https://gitcode.com/openharmony-tpc/chromium_cef.git
...
**备注: 138内核，拉取子仓编译错误，需要修改文件权限，如下图：**
   ![12](./res/12.png)
