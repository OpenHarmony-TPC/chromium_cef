...
#ifndef CEF_LIBCEF_BROWSER_EXTENSIONS_API_CONTEXT_MENUS_CONTEXT_MENUS_API_HELPERS_H_
#define CEF_LIBCEF_BROWSER_EXTENSIONS_API_CONTEXT_MENUS_CONTEXT_MENUS_API_HELPERS_H_
...
#ifdef OHOS_ARKWEB_EXTENSIONS
  CefMenuManager::OnContextMenusCreate(item_id.extension_key.extension_id, menu_manager->GetItemById(item_id));
#endif // OHOS_ARKWEB_EXTENSIONS
...
#ifdef OHOS_ARKWEB_EXTENSIONS
  CefMenuManager::OnContextMenusUpdate(item->extension_id(), item);
#endif // OHOS_ARKWEB_EXTENSIONS
  menu_manager->WriteToStorage(extension, item_id.extension_key);
  return true;
}
...
#endif  // CEF_LIBCEF_BROWSER_EXTENSIONS_API_CONTEXT_MENUS_CONTEXT_MENUS_API_HELPERS_H_