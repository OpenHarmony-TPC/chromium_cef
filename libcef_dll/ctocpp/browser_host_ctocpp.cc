...
//
// $hash=13d9359789a8f204261d2d945c9d7e6b6ba68a22$
//
...
NO_SANITIZE("cfi-icall") bool CefBrowserHostCToCpp::FinishDiscard() {
  shutdown_checker::AssertNotShutdown();

  cef_browser_host_t *_struct = GetStruct();
  if (CEF_MEMBER_MISSING(_struct, finish_discard))
    return false;

  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING

  // Execute
  int _retval = _struct->finish_discard(_struct);

  // Return type: bool
  return _retval ? true : false;
}

NO_SANITIZE("cfi-icall") bool CefBrowserHostCToCpp::FinishReload() {
  shutdown_checker::AssertNotShutdown();

  cef_browser_host_t *_struct = GetStruct();
  if (CEF_MEMBER_MISSING(_struct, finish_reload))
    return false;

  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING

  // Execute
  int _retval = _struct->finish_reload(_struct);
