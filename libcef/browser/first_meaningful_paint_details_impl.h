...
class CefFirstMeaningfulPaintDetailsImpl: public CefFirstMeaningfulPaintDetails {
 public:
  explicit CefFirstMeaningfulPaintDetailsImpl(int64_t navigationStartTime,
                                       int64_t firstMeaningfulPaintTime);

  CefFirstMeaningfulPaintDetailsImpl(const CefFirstMeaningfulPaintDetailsImpl&) = delete;
  CefFirstMeaningfulPaintDetailsImpl& operator=(const CefFirstMeaningfulPaintDetailsImpl&)
      = delete;
